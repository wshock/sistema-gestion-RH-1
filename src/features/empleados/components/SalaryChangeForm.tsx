...
import { salaryChangeSchema, type SalaryChangeInput } from "@/features/empleados/schemas";
 ...
 *
 * El salario vigente se muestra como referencia y no se edita: el envío
 * inserta un registro nuevo. Tras el éxito vuelve a la ficha.
 */
export function SalaryChangeForm({
  ...
  const form = useForm<SalaryChangeInput>({
    resolver: zodResolver(salaryChangeSchema) as Resolver<SalaryChangeInput>,
    defaultValues: {
      businessEntityId,
      rate: undefined,
        ...
        <CardContent className="space-y-4">
          ...
          {currentPay ? (
            ...
            <p className="text-muted-foreground text-sm">
              Este empleado todavía no tiene historial salarial.
            </p>
          )}
        </CardContent>
      </Card>
